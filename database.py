...
class Database:
 ...
 #######################   COMPETITION   ########################
    ...
    def get_player_photo(self, player_id):
        ...
        return player_photo
    def get_all_player_photos(self):
        with dbapi2.connect(self.db_url) as connection:
            with connection.cursor() as cursor:
                query = """
                    SELECT
                ...
                for (
                    ...
                    player_photos.append(player_photo)
    ...
    def update_player_attributes(self, player_attributes_key, player_attributes):
        with dbapi2.connect(self.db_url) as connection:
            with connection.cursor() as cursor:
                query = """
                ...
                cursor.execute(query, (
                    ...
                    player_attributes.foot,
                    player_attributes.height_in_cm,
                    player_attributes.market_value_in_eur,
                    player_attributes.highest_market_value_in_eur,
                    player_attributes.contract_expiration_date,
