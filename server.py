...
def create_app():
    ...
    app.add_url_rule("/players/filter-club/<int:club_id>/", view_func=views.club_player_page, methods=["GET", "POST"])
    ...
    app.add_url_rule("/players_attributes/<int:player_attributes_id>/edit", view_func=views.edit_attributes_page,
                     methods=["GET", "POST"])
    ...
    app.add_url_rule("/club_delete/<int:club_id>/", view_func=views.club_delete_page, methods=["GET", "POST"])
    #################### GAMES ###############################
    ...
    app.add_url_rule("/games/filter-club/<int:club_id>", view_func=views.club_games_page, methods=["GET", "POST"])
    app.add_url_rule("/games/filter-competition/<int:competition_id>", view_func=views.comp_games_page, methods=["GET", "POST"])
    ...
    db_url = "jdbc:postgresql://localhost:5432/DatabaseProject"
